...
<head>
    ...
    <title>Animations Lab — Démos</title>
</head>
<body class="main-content">
    ...
    <nav id="sidebarNav" class="sidebar">
        ...
        <div class="nav-section">
            <strong>Démos</strong>
            <a href="#triangleCanvas" data-scroll="true">WebGPU Triangle</a>
            <a href="#cubeCanvas" data-scroll="true">WebGPU Cube</a>
            <a href="#cubeCanvasThree" data-scroll="true">Cube Three</a>
            <a href="#oceanCanvas" data-scroll="true">Océan</a>
            <a href="#morphingCanvas" data-scroll="true">Morphing</a>
            <a href="#bloomCanvas" data-scroll="true">Galaxie Bloom</a>
        </div>
    </nav>

    <div id="canvasContainer" class="canvas-container">
        <h2 class="section-title">Démos</h2>

        <div class="canvas-card"><h1>WebGPU Triangle</h1><canvas id="triangleCanvas" width="800" height="500"></canvas></div>
        <div class="canvas-card"><h1>WebGPU Cube</h1><canvas id="cubeCanvas" width="800" height="500"></canvas></div>
        <div class="canvas-card"><h1>Three.js Cube</h1><canvas id="cubeCanvasThree" width="800" height="500"></canvas></div>
        <div class="canvas-card"><h1>Three.js Stars</h1><canvas id="starsCanvasThree" width="800" height="500"></canvas></div>
        <div class="canvas-card"><h1>Océan</h1><canvas id="oceanCanvas" width="800" height="500"></canvas></div>
        <div class="canvas-card"><h1>Texte flottant</h1><canvas id="textFloatCanvas" width="800" height="500"></canvas></div>
        <div class="canvas-card"><h1>Morphing de formes</h1><canvas id="morphingCanvas" width="800" height="500"></canvas></div>
        <div class="canvas-card"><h1>Particules logo</h1><canvas id="particlesLogoCanvas" width="800" height="500"></canvas></div>
        <div class="canvas-card"><h1>Wormhole</h1><canvas id="wormholeCanvas" width="800" height="500"></canvas></div>
        <div class="canvas-card"><h1>Terrain procédural</h1><canvas id="terrainCanvas" width="800" height="500"></canvas></div>
        <div class="canvas-card"><h1>Galaxie Bloom + Aberration</h1><canvas id="bloomCanvas" width="800" height="500"></canvas></div>
        <div class="canvas-card"><h1>Eau avec reflets</h1><canvas id="waterCanvas" width="800" height="500"></canvas></div>
        <div class="canvas-card"><h1>Jeu de la vie 3D</h1><canvas id="gameOfLifeCanvas" width="800" height="500"></canvas></div>
    </div>
